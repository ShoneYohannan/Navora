...
2. Distribute the budget cap across categories realistically. The total_estimated must be less than or equal to the Budget Cap. Ensure all prices in the itinerary and budget breakdown are estimated and formatted in {currency}.
